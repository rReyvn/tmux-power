...
user=$(whoami)
LS="#[fg=$TC,bg=$BG]$larrow#[fg=$G04,bg=$TC,bold] $user_icon $user@#h #[fg=$TC,bg=$G06,nobold]$rarrow#[fg=$TC,bg=$G06] $session_icon #S "
...
RS="#[fg=$G06]$larrow#[fg=$TC,bg=$G06] $time_icon $time_format #[fg=$TC,bg=$G06]$larrow#[fg=$G04,bg=$TC] $date_icon $date_format #[fg=$TC,bg=$BG]$rarrow"
...
tmux_set window-status-format         "#[fg=$G06,bg=$BG]$larrow#[fg=$TC,bg=$G06] #I:#W#F #[fg=$G06,bg=$BG]$rarrow "
tmux_set window-status-current-format "#[fg=$TC,bg=$BG]$larrow#[fg=$BG,bg=$TC,bold] #I:#W#F #[fg=$TC,bg=$BG,nobold]$rarrow "
